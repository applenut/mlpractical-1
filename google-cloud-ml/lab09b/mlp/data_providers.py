# -*- coding: utf-8 -*-
#
# Adapted from https://github.com/CSTR-Edinburgh/mlpractical/
# MSD10GenreDataProvider has been modified slightly.
#
"""Data providers.
...
class MSD10GenreDataProvider(OneOfKDataProvider):
    ...
    def __init__(self, which_set='train', batch_size=100, max_num_batches=-1,
                 shuffle_order=True, rng=None, gcloud=None):
        ...
        if gcloud:
          ...
          # 'gcloud' should be the Google Cloud Storage bucket to be used
